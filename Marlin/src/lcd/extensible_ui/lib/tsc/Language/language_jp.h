...
#define _LANGUAGE_JP_H_
    ...
    #define JP_SILENT_ON            "ミュー"
    #define JP_SILENT_OFF           "サウン"
    #define JP_SHUT_DOWN            "シャットダウン"
    #define JP_RGB_SETTINGS         "LED カラー"
    #define JP_RGB_RED              "赤色"
    #define JP_RGB_GREEN            "緑色"
    #define JP_RGB_BLUE             "青色"
    #define JP_RGB_WHITE            "白色"
    ...
    #define JP_SMART_RUNOUT_ON      "スマートON"
    ...
    #define JP_FILAMENT_RUNOUT      "材料の異常を検出しました。!"
    ...
    #define JP_IS_PAUSE             "印刷中に押し出すことができませんでした。"
    #define JP_AUTO_SHUT_DOWN       "オートパワー"
    #define JP_MANUAL_SHUT_DOWN     "マニュアル"
    ...
    #define JP_STATUS_INFO          "状態"
    #define JP_ERROR                "エラー"
    #define JP_TIPS                 "ヒント"
    #define JP_EEPROM_SAVE_SUCCESS  "EEPROMパラメータが正常に保存"
    #define JP_EEPROM_SAVE_FAILED   "EEPROMパラメータが失敗しました"

...
const char *const tc_pack[LABEL_NUM]={
  ...
  TC_TFTSD_REMOVED,
  TC_U_DISK,
  TC_READ_U_DISK_ERROR,
  TC_U_DISK_INSERTED,
  TC_U_DISK_REMOVED,
  TC_ONBOARDSD,
  TC_READ_ONBOARDSD_ERROR,
  TC_FILAMENT_RUNOUT,
  TC_PREHEAT,
  TC_PREHEAT_BOTH,
  TC_PREHEAT_PLA,
  ...
  TC_TOUCH_TO_EXIT,
  TC_MAINMENU,
  TC_WAIT_TEMP_SHUT_DOWN,
  TC_FORCE_SHUT_DOWN,
  TC_SHUTTING_DOWN,
  TC_PRINTING_COMPLETED,
  TC_STATUS_INFO,
  TC_ERROR,
  TC_TIPS,
  TC_EEPROM_SAVE_SUCCESS,
  TC_EEPROM_SAVE_FAILED,
};
// #define LANGUAGE_RUSSIAN
// #define LANGUAGE_EN
// #define LANGUAGE_EN_CN_TC_RU_JP
 #define LANGUAGE_EN_FR_DE_ES_IT
// #define LANGUAGE_EN_CN_TC
// #define LANGUAGE_KOREAN
// #define LANGUAGE_SPAIN
// #define LANGUAGE_TRAD_CHINESE

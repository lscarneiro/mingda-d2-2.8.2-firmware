...
#include "../core/debug_out.h"
  ...
  bool MarlinSettings::save() {
    ...
    #if ENABLED(BABYSTEP_DISPLAY_TOTAL)
      EEPROM_WRITE(babystep.axis_total[BS_TOTAL_AXIS(Z_AXIS)]);
    #endif
  ...
  bool MarlinSettings::_load() {
    ...
    if (strncmp(version, stored_ver, 3) != 0) {
      ...
      #if ENABLED(BABYSTEP_DISPLAY_TOTAL)
        EEPROM_READ(babystep.axis_total[BS_TOTAL_AXIS(Z_AXIS)]);
      #endif
...
void MarlinSettings::reset() {
  ...
  #if ENABLED(BABYSTEP_DISPLAY_TOTAL)
    babystep.axis_total[BS_TOTAL_AXIS(Z_AXIS)] = 0;
  #endif
  ...
  void MarlinSettings::report(const bool forReplay) {
     ...
     */
      ...
      CONFIG_ECHO_START();
      SERIAL_ECHOLNPAIR(
        "  M290 Z", int(babystep.axis_total[BS_TOTAL_AXIS(Z_AXIS)])
      );
    #endif
  }
